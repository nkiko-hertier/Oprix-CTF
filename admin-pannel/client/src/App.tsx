...
import SignUp from "@/pages/invitations";
...
import CompetitionManage from "@/pages/competition-manage";
  ...
  return (
    <>
      <Switch>
        ...
        <Route path="/competitions/:id" component={CompetitionManage} />
